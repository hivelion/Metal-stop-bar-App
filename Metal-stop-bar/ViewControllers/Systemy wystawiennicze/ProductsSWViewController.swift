//
//  ProductsSWViewController.swift
...
class ProductsSWViewController: UITableViewController{
...
//        self.performSegue(withIdentifier: "infoViewSW", sender: nil)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        DispatchQueue.main.async {
                if segue.identifier == "infoViewSW" {
            let controller = segue.destination as! ProduktSWInfoViewController
